      ...
      <div class="checkIn part">
        ...
        <div class="time checkItem">
          <div class="startTime timeItem">
            <span>出发地址：{{ form.startPlace }}</span>
          </div>
          <div class="endTime timeItem">
            <span>到达地址：{{ form.endPlace }}</span>
          </div>
        </div>
        <div class="time checkItem">
          <div class="timeItem">
          ...
          <div class="startTime timeItem">
            <span>发车时间：{{ formatDate(form.startTime) }}</span>
          </div>
          <div class="endTime timeItem">
  ...
  export default {
    ...
    methods: {
      ...
      getTicketNews() {
        ...
        this.$http.get("/ticket/ticketNews/" + id).then((response) => {
